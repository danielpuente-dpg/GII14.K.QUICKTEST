...
\\\ & que se emplean para realizar el login y no tener que \\\
...
{ \multicolumn{1}{l}{HU4}\\}{ 
Título & Como un usuario autenticado, podrá ver los cursos en
\\\ & los que se encuentra matriculado en sus estudios, 
\\\ & obtenidos desde la aplicación Moodle de su institución.\\
Rol & Alumno o profesor autenticado. \\
...
{ \multicolumn{1}{l}{HU8}\\}{ 
Título & Como un usuario autenticado, se podrá consultar al \\\
& sistema sobre la calificación obtenida. \\
Rol & Alumno autenticado. \\
