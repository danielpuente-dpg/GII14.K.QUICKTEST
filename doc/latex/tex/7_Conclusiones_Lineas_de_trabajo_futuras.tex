...
\begin{itemize}
	...
	\begin{list}{-}{}
		\item Modificar la clase encargada de manejar la conexión a la base de datos implementando un patrón Singleton. De esta forma, limitaremos a que exista un único hilo para acceder a la misma.
		...
		\item Incorporar un sistema que permita implementar la concurrencia.
	\end{list}
	
	\item \textbf{Aplicación Android:}
	\begin{list}{-}{}
		\item Permitir que la calificación de los alumnos pueda ser almacenada en el apartado de calificaciones del curso,  mediante alguna biblioteca en Android que permita el envío de datos a Moodle cumpliendo el estándar LTI.
