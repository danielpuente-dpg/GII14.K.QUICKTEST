...
public class InfoGradeActivityTest {
    ...
    @Test
    public void infoGradeActivityTest() {
        ...
        ViewInteraction appCompatTextView = onView(
                allOf(withId(android.R.id.title), withText("Revisar"), isDisplayed()));
        appCompatTextView.perform(click());

        ViewInteraction appCompatButton3 = onView(
                allOf(withId(R.id.buttonViewResults), withText("Ver resultados"), isDisplayed()));
