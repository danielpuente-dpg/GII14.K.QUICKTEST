...
<!-- Modal VERDE -->
<div class="modal fade" id="myModalVerde" role="dialog">
    ...
    <div class="modal-header">
        ...
        <h4 class="modal-title" style="display: inline">
            <?php echo _("Comodín usado:"); ?> <h4 style="display: inline"
                                                   class="text-success"><?php echo _("Verde"); ?> </h4></h4>
    </div>
    <div class="modal-body">
        ...
        <div class="row">
            <div class="col-lg-8 col-lg-push-2">
                <img class="img-responsive img-rounded" src="/_QuickTest_TFG/app/webroot/images/correctaVerde.PNG" alt="correctaVerde">
            </div>
        </div>
        <div class="text-center">
            <h6 class=" text-lowercase"
                style="text-transform:initial;"><?php echo _("Puntuación total= Puntuación máxima X corrector "); ?></h6>
            <h5 class=" text-success " style="display: inline; "><?php echo _("33 %"); ?></h5>
            <h6 class=" text-lowercase" style="display: inline; text-transform:initial;"> de 10p = </h6>
            <h4 class=" text-success " style="display: inline"> 3.33</h4>
            <h6 class=" text-lowercase"
        ...
        <div class="row">
            <div class="col-lg-8 col-lg-push-2">
                <img class="img-responsive" src="/_QuickTest_TFG/app/webroot/images/incorrectaVerde.PNG" alt="correctaVerde">
            </div>
        </div>
        ...
        <div class="text-center">
            <h6 class=" text-lowercase"
                style="text-transform:initial;"><?php echo _("Puntuación total= Puntuación máxima X corrector "); ?></h6>
            <h5 class=" text-danger " style="display: inline; "><?php echo _("-50 %"); ?></h5>
            <h6 class=" text-lowercase" style="display: inline; text-transform:initial;"> de 10p = </h6>
            <h4 class=" text-danger " style="display: inline"> -0.50</h4>
            <h6 class=" text-lowercase"
                style="display: inline; text-transform:initial;"><?php echo _("puntos"); ?></h6>
        </div>
